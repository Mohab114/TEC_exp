function current_measured = SMU_sampling(SMU, channel, trig_volt)
    ...
    if( channel == 1 || channel == 2 )
        ...
        fprintf( SMU, [ ':SENS' ch_str ':CURR:NPLC 0.1' ] ); % Sets the number of power line cycles (NPLC) value instead of setting the integration time for one point measurement.
