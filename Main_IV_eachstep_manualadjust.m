...
Totaldistance = 0.3; %total distance of 500 um
...
VA_list = -5.0 : 0.2 : 15.0;    % Top-level sweep: sourcemeter bias voltage
channel = 1;
compliance = 100e-6;  % 100 uA
